...
const French2 = ["Testez-le","Sélectionnez une image et commencez la détection","Choisissez une image ...","Choisissez le type de détection","Soumettre","Ou bien","Démarrer la détection en temps réel",' <img src="../static/images/webcam-512_2.png" alt="webcam" id="webcam" width="100px" style="margin: auto;"> <br> <br> <br> <span style="font-size: 20px;">Live</span> ','Cliquez sur "q" pour sortir du mode detection en temp réel'];
...
const Arab2 = ["اختبرها","حدد صورة وابدأ الاكتشاف","... اختر صورة","اختر نوع الكشف","إرسال","أو","ابدأ الاكتشاف في الوقت الفعلي",'<img src="../static/images/webcam-512_2.png" alt="webcam" id="webcam" width="100px" style="margin: auto;"> <br> <br> <br> <span style="font-size: 20px;">مباشر</span> ',' "q" للخروج من وضع الكشف في الوقت الفعلي أنقر على '];
